...
final class ResponseRoundTripTest extends TestCase
{
    ...
    public static function responses(): iterable
    {
        ...
        yield 'Audio/TranscriptionResponse' => [TranscriptionResponse::class, AudioTranscriptionFixture::ATTRIBUTES];
        yield 'Containers/ContainerFileResponse' => [ContainerFileResponse::class, ContainerFileRetrieveFixture::ATTRIBUTES];
        yield 'Containers/ListContainerFilesResponse' => [ListContainerFilesResponse::class, ContainerFilesListFixture::ATTRIBUTES];
        yield 'Files/DeleteFileResponse' => [DeleteFileResponse::class, FilesDeleteFixture::ATTRIBUTES];
        yield 'Files/FileResponse' => [FileResponse::class, FilesRetrieveFixture::ATTRIBUTES];
        yield 'Files/ListFilesResponse' => [ListFilesResponse::class, FilesListFixture::ATTRIBUTES];
        yield 'Images/ImagesResult' => [ImagesResult::class, ImagesGenerateFixture::ATTRIBUTES];
        yield 'Images/ListImageModelEndpointsResponse' => [ListImageModelEndpointsResponse::class, ImagesModelEndpointsFixture::ATTRIBUTES];
        yield 'Images/ListImageModelsResponse' => [ListImageModelsResponse::class, ImagesModelsFixture::ATTRIBUTES];
        yield 'Videos/ListVideoModelsResponse' => [ListVideoModelsResponse::class, VideosModelsFixture::ATTRIBUTES];
        yield 'Videos/VideoJobResponse' => [VideoJobResponse::class, VideosJobFixture::ATTRIBUTES];
        yield 'Byok/ByokKeyResponse' => [ByokKeyResponse::class, ['data' => ByokListFixture::ATTRIBUTES['data'][0]]];
        yield 'Byok/ListByokKeysResponse' => [ListByokKeysResponse::class, ByokListFixture::ATTRIBUTES];
        yield 'DataResponse' => [DataResponse::class, ['data' => ['any' => 'shape']]];
        yield 'Presets/ListPresetsResponse' => [ListPresetsResponse::class, PresetsListFixture::ATTRIBUTES];
        yield 'Presets/ListPresetVersionsResponse' => [ListPresetVersionsResponse::class, PresetVersionsFixture::ATTRIBUTES];
        yield 'Presets/PresetResponse' => [PresetResponse::class, PresetRetrieveFixture::ATTRIBUTES];
        yield 'Presets/PresetVersionResponse' => [PresetVersionResponse::class, ['data' => PresetVersionsFixture::ATTRIBUTES['data'][0]]];
        yield 'Workspaces/ListWorkspaceBudgetsResponse' => [ListWorkspaceBudgetsResponse::class, WorkspaceBudgetsFixture::ATTRIBUTES];
        yield 'Workspaces/ListWorkspaceMembersResponse' => [ListWorkspaceMembersResponse::class, WorkspaceMembersFixture::ATTRIBUTES];
        yield 'Workspaces/ListWorkspacesResponse' => [ListWorkspacesResponse::class, WorkspacesListFixture::ATTRIBUTES];
        yield 'Workspaces/WorkspaceResponse' => [WorkspaceResponse::class, WorkspaceRetrieveFixture::ATTRIBUTES];
