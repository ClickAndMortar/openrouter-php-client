...
use OpenRouter\Responses\Oauth\Jwk;
use OpenRouter\Responses\Organization\CreatedOrganization;
use OpenRouter\Responses\Organization\OrganizationGrant;
use OpenRouter\Responses\Organization\OrganizationManagementKey;
use OpenRouter\Responses\Organization\OrganizationMember;
use OpenRouter\Responses\Scim\ScimSyncJob;
...
final class UnknownFieldPreservationTest extends TestCase
{
    ...
    public static function entityProvider(): iterable
    {
        ...
        yield 'Organization/CreatedOrganization' => [CreatedOrganization::class, OrganizationCreateFixture::ATTRIBUTES['organization']];
        yield 'Organization/OrganizationGrant' => [OrganizationGrant::class, OrganizationCreateFixture::ATTRIBUTES['grant']];
        yield 'Organization/OrganizationManagementKey' => [OrganizationManagementKey::class, OrganizationCreateFixture::ATTRIBUTES['management_key']];
        yield 'Oauth/Jwk' => [Jwk::class, OauthFixture::JWKS['keys'][0]];
        yield 'Scim/ScimSyncJob' => [ScimSyncJob::class, ScimSyncJobFixture::ATTRIBUTES['data']];
