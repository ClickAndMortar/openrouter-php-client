...
/**
 * Assistant message for Anthropic `/messages`. `content` is either a plain
 * string or a list of content blocks — each entry may be either a typed
 * {@see MessagesContentBlock} or a raw array passed through unchanged.
 */
final class AssistantMessage implements MessagesMessage
{
    /**
