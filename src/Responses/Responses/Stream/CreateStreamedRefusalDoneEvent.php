...
/**
 * `response.refusal.done` — emitted when a refusal content part is fully
 * produced. `$refusal` holds the complete refusal string.
 */
final class CreateStreamedRefusalDoneEvent extends CreateStreamedResponse
{
    /**
    ...
    private function __construct(
        ...
        parent::__construct('response.refusal.done', $attributes);
    }
