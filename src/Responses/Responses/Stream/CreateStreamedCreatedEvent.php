 ...
 * server-side, before any output is generated. Carries the initial response
 * snapshot under `$response`.
 */
final class CreateStreamedCreatedEvent extends CreateStreamedResponse
{
    ...
    private function __construct(
        ...
        parent::__construct('response.created', $attributes);
    }
